...
namespace siphon {
    namespace util {
        ...
        {
            return fifo_pointer->stored_items_number >= fifo_pointer->capacity_of_items_number;
        }

        bool isFIFOEmpty(FIFOPointer fifo_pointer)
        {
            return fifo_pointer->stored_items_number == 0;
        }
        ...
        static void fifoCopyFrom(FIFOPointer fifo_pointer, block_seed::blockMessage * block_message)
        {
            ...
            memcpy(block_message->udp_parameters, fifo_pointer->buffer_pool[fifo_pointer->read_offset]+sizeof(int)+sizeof(int), 6);
            memcpy(block_message->payload_ptr, fifo_pointer->buffer_pool[fifo_pointer->read_offset]+sizeof(int)+sizeof(int)+6, block_message->payload_size);
        ...
        static void fifoCopyTo(FIFOPointer fifo_pointer, const block_seed::blockMessage * block_message)
        {
            ...
            fifo_pointer->buffer_pool[fifo_pointer->write_offset] = (unsigned char *)(malloc(sizeof(int) + sizeof(int) + 6 + payload_size));
            ...
            memcpy(fifo_pointer->buffer_pool[fifo_pointer->write_offset]+sizeof(int)+sizeof(int), block_message->udp_parameters, 6);
            memcpy(fifo_pointer->buffer_pool[fifo_pointer->write_offset]+sizeof(int)+sizeof(int)+6, block_message->payload_ptr, payload_size);
